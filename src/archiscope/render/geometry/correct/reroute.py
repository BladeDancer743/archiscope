...
def compute_reroute_vector(
    violations: list[Violation], boxes: dict[str, Rect], edges: list[dict]
) -> dict:
...
def apply_reroute(grid: CharGrid, boxes: dict[str, Rect], edges: list[dict], vector: dict):
