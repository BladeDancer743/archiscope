...
from ..draw.grid import CharGrid, Rect, str_width, pad_str, BLOCK_FULL, BLOCK_LIGHT
from ..verify.rules import VerifyContext


def render_hbar(ctx: VerifyContext, data: list[dict], style: str = "gantt",
                max_bar_chars: int = 40) -> str:
